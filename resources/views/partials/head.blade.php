...
<meta name="description" content="OMI-BLOG : {{ e(trim(str_replace(["\r", "\n"], ' ', \App\Config::where(['name' => 'blurb'])->first()->value))) }}">
<meta name="author" content="Dwayne Pivac @ OMI Ltd.">
<title>{{ \App\Config::where(['name' => 'title'])->first()->value }} - @yield('title')</title>
<link rel="canonical" href="https://blog.omi.nz/@yield('canonical', 'https://blog.omi.nz')">
