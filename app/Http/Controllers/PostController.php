  ...
  */
  ...
  public function store(Request $request) {
      ...
      if (isset($request->summary)) {
          $post->summary = strip_tags(Purifier::clean($request->summary));
      } else {
          $post->summary = strip_tags(Purifier::clean($request->body));
      }
      ...
      if ($request->hasFile('featured_image')) {
        ...
        if (strtolower($image->getClientOriginalExtension()) === "gif") {
          $image->move("$location/full", $filename);#Directly move GIF without using Intervention Image - keeps gif as original
        }
        #
        $post->image = $filename;
      }
  ...
  public function update(Request $request, $id) {
      ...
      $post->summary = strip_tags(Purifier::clean($request->input('summary')));
