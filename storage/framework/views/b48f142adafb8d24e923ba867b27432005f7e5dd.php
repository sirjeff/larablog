...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div>
                <img src="<?php echo e(asset('images/thumb/' . $post->image)); ?>" alt="<?php echo e($post->image); ?>" class="img-thumbnail">
            ...
            <?php echo e(Form::label('featured', 'Featured Post?:')); ?>

            <?php echo e(Form::checkbox("featured", null, null, ["class" => "form-group"])); ?>

            <br>
            <?php echo e(Form::label('sticky', 'Pin post?:')); ?>

            <?php echo e(Form::checkbox("sticky", null, null, ["class" => "form-group"])); ?>
